import { ITypeOfAncestor, IResponseSources, IResponseNews } from './interfaces';
...
type KeyValuePairsType = Record<string, string>;

export function isResponseNews(res: IResponseNews | IResponseSources): res is IResponseNews {
    return typeof res === 'object' && res !== undefined && res !== null && 'status' in res && 'articles' in res;
}

export function isResponseSources(res: IResponseNews | IResponseSources): res is IResponseSources {
