...
class Blobs {
  public constructor() {
    const blobLeft: SVGSVGElement = createSvg("./assets/background/blob.svg#blob-left", "blob-left");
    const blobRight: SVGSVGElement = createSvg("./assets/background/blob.svg#blob-left", "blob-right");
